...
var UsersRouter = /** @class */ (function (_super) {
    ...
    UsersRouter.prototype.setupRoutes = function () {
        ...
        */
        ...
        this.expressRouter.post('/:id/notes/:noteid/comments', [securityMiddleware_1.SecurityMiddleware.RequireAuth], UsersRouter.useController.addComments);
        this.expressRouter.get('/:id/notes/comments', [securityMiddleware_1.SecurityMiddleware.RequireAuth], UsersRouter.useController.getComments);
    };
